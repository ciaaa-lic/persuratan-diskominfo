  ...
  <div class="min-h-screen p-4 md:p-6 flex items-center justify-center">
    <div class="app-window w-full max-w-[1600px] h-[calc(100vh-2rem)] md:h-[calc(100vh-3rem)] flex overflow-hidden">
      ...
      <nav class="sidebar-nav flex flex-col items-center py-5 gap-1">
        ...
        <!-- Logout -->
        <button @click="handleLogout" class="nav-item" title="Keluar" style="color: #ef4444;">
      ...
      <div class="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <div class="topbar flex-shrink-0">
          <div class="flex items-center gap-3">
            <div>
              <h2 class="text-base font-bold text-gray-900 dark:text-white leading-none">
                {{ currentPageTitle }}
              </h2>
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="relative hidden md:block">
              ...
              <input
                ...
                class="w-60 pl-9 pr-4 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 dark:focus:ring-red-900/30 transition-all"
              />
            </div>
            ...
            <div class="relative">
              ...
              <div v-if="notifOpen" class="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 overflow-hidden">
                <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <button @click="markAsRead" class="text-xs text-red-600 hover:underline">Tandai dibaca</button>
                </div>
                <div class="max-h-64 overflow-y-auto divide-y divide-gray-50 dark:divide-gray-700/50">
                  <div v-for="notif in notifications" :key="notif.id" class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors" :class="{'bg-red-50 dark:bg-red-900/10': !notif.read}">
...
import {
  HomeIcon, DocumentTextIcon, FolderIcon,
  BellIcon, MagnifyingGlassIcon, SunIcon, MoonIcon, ArrowRightOnRectangleIcon
...
const navigation = [
  ...
  { name: 'Arsip per Bidang', href: '/admin/bidang', icon: FolderIcon },
  { name: 'Rekap Surat', href: '/admin/rekap', icon: DocumentTextIcon },
]
...
const markAsRead = () => notifStore.markAllAsRead()
