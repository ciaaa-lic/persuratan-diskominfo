...
async function main() {
  ...
  const users = [
    { email: 'admin@diskominfo.go.id', name: 'Admin Utama', password: defaultPassword, role: Role.ADMIN, bidang: null },
    { email: 'aptika@diskominfo.go.id', name: 'Bid. APTIKA', password: aptikaPassword, role: Role.USER, bidang: 'APTIKA' },
    { email: 'persandian@diskominfo.go.id', name: 'Bid. PERSANDIAN', password: persandianPassword, role: Role.USER, bidang: 'PERSANDIAN' },
    { email: 'pde@diskominfo.go.id', name: 'Bid. PDE', password: pdePassword, role: Role.USER, bidang: 'PDE' },
    { email: 'humas@diskominfo.go.id', name: 'Bid. HUMAS', password: humasPassword, role: Role.USER, bidang: 'HUMAS' },
  ];
